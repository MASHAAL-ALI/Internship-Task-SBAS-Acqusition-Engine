...
module if_stimulus_gen (
    ...
    //    Taps 3 & 7 (1-indexed) = g2[1] ^ g2[5] (0-indexed)
    // =================================================================
    reg [9:0] g1, g2;
    ...
    wire g1_out      = g1[9];
    wire g2_selected = g2[1] ^ g2[5];        // <<<FOR PRN 1 HERE
